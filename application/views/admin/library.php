                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $lib['deskripsi_singkat_buku'] ?></td>    
                                        <td><?php echo $lib['status'] ?></td>
                                        <td>
                                        <a href="<?php echo site_url('admin/edit/'.$lib['no_buku']) ?>"><button type="button" class="btn btn-success waves-effect">
                                                <i class="material-icons">home</i>
                                            </button>
                                        </a>
                                        	
                                        <a href="<?php echo site_url('admin/delete/'.$lib['no_buku']) ?>"><button type="button" class="btn btn-danger waves-effect">
